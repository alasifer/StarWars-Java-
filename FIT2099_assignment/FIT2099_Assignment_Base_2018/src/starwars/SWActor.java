...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	/**
	 * Retrieves a boolean which checks the <code>SWActor</code> is under training
	 * @return a boolean which checks the <code>SWActor</code> is under training
	 */
	public Force getForceAbility()
	{
		return this.force;
	}

	/**
	 * Sets the <code>ForceAbility</code> object to determine the amount of <code>ForceAmount</code> the <code>SWActor</code> has
	 * @param forceAbility
	 * 			- a <code>ForceAbility</code> object to determine the amount of <code>ForceAmount</code> the <code>SWActor</code> has
	 */
	public void setForce(Force forceAbility)
	{
		this.force = forceAbility;
	}

	/**
	 * Sets the amount of <code>ForceAmount</code> the <code>SWActor</code> has
	 * @param amount
	 * 			- amount of <code>ForceAmount</code> the <code>SWActor</code> has
	 */
	public void setForceAmount(int amount)
	{
		if (this.force != null)
		{
			this.force.setForce(amount);
		}
	}

	/**
	 * Sets the boolean if the <code>SWActor</code> is under training
	 * @param result
	 * 			- boolean if the <code>SWActor</code> is under training
	 */
	public void setTrained(boolean result){
		this.trained = result;
	}
	...
	/**
	 * store the current location of the actor in order to be used to compare it to the actor next location
	 * @param a the actor
	 */
	public void setCurrloc(SWActor a) {
		currloc = SWWorld.getEntitymanager().whereIs(a);
	}

	/**
	 * @return 	returns the actor current location
	 */
	public SWLocation getCurrloc() {
		return currloc;
	}
	...
	/**
	 * set the counter to an integer <code>a</code>
	 * @param a integer
	 */
	...
	public void travel(initMap curr, initMap target){
